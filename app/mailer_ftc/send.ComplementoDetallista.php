<?php
    ...
    require_once('./app/PHPMailer/class.smtp.php');
     ...
     $asunto = "Timbrar el documento $docf .";  
     $mensaje.= "<p>Solicitud para Timbrar el documento $docf con el complemento Detallista de Liverpool.</p>";
     $mensaje.= "<p>Favor de contestar al correo $respuesta , Usuario Solicita: $usuario </p>";
     $mensaje.= "<p><br/> Atentamente <br/> Ferretera Pegaso</p>";
     try {
        $mail = new PHPMailer();
        ...
        $mail->Password   = "genseg89+";
         ...
         $mail->SetFrom('cxpferreterapegaso@gmail.com' , "Pegaso Timbrar el documento con el complemento detallista".$docf); // Esccribe datos de contacto
         $mail->Subject = $asunto;
