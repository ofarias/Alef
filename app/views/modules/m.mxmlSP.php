        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <center><a href="index.php?action=verXMLSP&mes=0&anio=<?php echo $a->ANIO?>&ide=<?php echo $ide?>" class="btn btn-default"><img src="    http://icons.iconarchive.com/icons/mcdo-design/smooth-leopard/64/Route-Folder-Blue-icon.png"></a></center>
                    </div>
                </div>
            </div>     
            <?php endforeach;?>
            <?php foreach ($subMenuXMLSP as $key): 
                ...
                <div class="panel-body">
                    ...
                    <p>Monto Sin procesar: </p>
                    <p>Sub Total: <?php echo '$ '.number_format($key->EGRESOSS,2)?></p>
                    <p>Total: <?php echo '$ '.number_format($key->EGRESOST,2)?></p>
                    <center><a href="index.php?action=verXMLSP&mes=<?php echo $key->MES?>&anio=<?php echo $key->ANIO?>&ide=<?php echo $ide?>" class="btn btn-default"><img src="http://icons.iconarchive.com/icons/mcdo-design/smooth-leopard/64/Route-Folder-Blue-icon.png"></a></center>
                </div>
            </div>
        </div>        
            <?php endforeach ?>
