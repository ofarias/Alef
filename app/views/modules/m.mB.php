            ...
            <div class="col-xs-12 col-md-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <center><a href="index.php?action=seguimientoCajas" class="btn btn-default" target="popup" onclick="window.open(this.href, this.target, 'width=1200, height=900')"><img src="app/views/images/Clipboard-Paste-icon.png"></a></center>
                    </div>
                </div>
            </div>
              <div class="col-md-4">
