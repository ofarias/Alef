...
<div class="panel panel-default">
	<div class="panel panel-heading">
		<h3>Alta de Centro de Compras</h3>
	</div>
<br />
<div class="panel panel-body">
		...
		<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="number" step="1000" name="lincred" min="0" placeholder="Linea de Credito" value="" class=" form form-control" required="required">
				</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group col-lg-12 text-center">
			...
			<div class="form-group">
    			<div class="col-lg-offset-2 col-lg-10">
					...
					<button name="creaCC" type="submit" value="enviar" class="btn btn-success"> Crear <i class="fa fa-floppy-o"></i></button>
				</div>
			</div>
		</form>
	</div>
