...
<div class="row">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-RecibirLogistica">
                                  ...
                                  <tbody>
                                       ...
                                       <tr class="odd gradeX" <?php echo $color;?> id="linea_<?php echo $i?>" >
                                            ...
                                            <td><a href="index.php?action=verComprobantesRecibo&idc=<?php echo $caja ?>" target="pop-up" ><font color="red" size="3pxs"><b><?php echo $data->DOCUMENTO;?></b></font></a></td>
                                            ...
                                            <td align="center"><b><?php echo '$ '.number_format($data->IMPORTE,2);?></b></td>
                                            <td align="center"><font color="red" size="3pxs"><b><?php echo '$ '.number_format($data->SALDOFINAL,2);?></b></font></td>
                                            <td align="center"><?php echo '$ '.number_format($data->DET_COBRADO,2);?></td>
                                            <td align="center"><?php echo $data->DET_LLAMADAS;?></td>
                                            <td align="center"><?php echo $data->DET_VISITAS;?></td>
                                            <td align="center"><?php echo $data->DET_CORREOS;?></td>
                                            <td align="center"><?php echo $data->DET_GERENCIA;?></td>
                                            <td align="center"><?php echo $data->DET_CORTE_CREDITO;?></td>
                                        </tr>
                                        <?php endforeach; ?>
                                 </tbody>
                                 </table>
        ...
        <div>
            <font size="5pxs" ><b> Monto de los documentos: <?php echo '$ '.number_format($total,2)?> </b></font>
        </div> 
</div>
