...
<label id="info"></label>
    ...
    <div class="panel panel-default">
              ...
              <div class="panel-body">
                  ...
                  <center><a href="index.php?action=edoCta_docs" class="btn btn-default" target="popup" onclick="window.open(this.href, this.target, 'width=1200,height=820'); return false;"><img src="app/views/images/cobranza/dinero_v1.jpg" default="smile"></a></center>
              </div>
    </div>
<label id="algo"></label>
<p id="algo2"></p>
                 ...
                 <div class="table-responsive">                            
                        <table class="table table-bordered" id="dataTables-CarteraXCliente">
                            ...
                            <tr>
                                ...
                                <th>Cliente<br/>Plazo CC</th>
                                <th>Importe</th>
                                <th>Fecha Documento /<br/> Fecha Cobranza </th>
                                <th>Dias <br/> Vencido</th>
                                <th>Aplicaciones</th>
                        ...
                        <tbody>
                            ...
                            ?>     
                                    <tr class="odd gradeX" <?php echo $color?> >
                                        ...
                                        <td> <?php echo '<font color="purple">'.$doc->FECHA_DOC.'</font><br/> <font color="blue">'.$doc->FECHA_COBRANZA.'</font><br/>'?></td>
                                       <td align="center"><b><?php echo $doc->VENCIMIENTO?></b></td>
                                        <td align="right"><font color="red"><b><?php echo '$ '.number_format($doc->APLICADO,2,".",",");?></b></font></td>
