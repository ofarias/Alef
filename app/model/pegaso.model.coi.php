                ...
                foreach ($impuestos as $imp){
                    ...
                    if($partAux == $par){
                        ...
                        if($tf=='Retencion'){
                            ...
                            $this->query="SELECT * FROM FTC_PARAM_COI WHERE impuesto = '$impuesto' and tasa=$tasa and status = 1 and factor = '$factor' and tipo = '$tf' and poliza ='$tipo'";
                        }
                        $res=$this->EjecutaQuerySimple();
                        ...
                        $concepto = substr($rowImp->NOMBRE.' de la partida '.$partAux,0,120);
                        $this->query="INSERT INTO $tbAux (TIPO_POLI, NUM_POLIZ, NUM_PART, PERIODO, EJERCICIO, NUM_CTA, FECHA_POL, CONCEP_PO, DEBE_HABER, MONTOMOV, NUMDEPTO, TIPCAMBIO, CONTRAPAR, ORDEN, CCOSTOS, CGRUPOS, IDINFADIPAR, IDUUID) 
